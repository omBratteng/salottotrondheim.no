...
const SoMeLinks = (): JSX.Element => (
	<Div>
		<SoMeLink href="https://www.facebook.com/salottotrondheim.no/" title="Salotto på Facebook">
			<Facebook className="svg-inline--fa fa-fw" />
		</SoMeLink>

		<SoMeLink href="https://www.instagram.com/salottotrondheim/" title="Salotto på Instagram">
